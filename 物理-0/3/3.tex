...
\begin{solution}
    ...
    (b) Suppose the car is moving at the speed \( v \) , and the fricitional force is \( f \) , where the positive \( f \) represent pointing towards the center. Then by the Newton's Second Law, we get
    \[ \begin{cases}
